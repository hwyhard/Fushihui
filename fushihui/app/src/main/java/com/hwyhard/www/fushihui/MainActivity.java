...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MessageAdapter messageAdapter = new MessageAdapter(createBeanList());
        messageRv.setAdapter(messageAdapter);
    }
    private List<MessageBean> createBeanList(){
        List<MessageBean> list = new ArrayList<>();
        MessageBean messageBean1 = new MessageBean();
        messageBean1.setItemPic(R.drawable.test_pic1);
        messageBean1.setItemPrimaryTitle("理想还能走多远？");
        messageBean1.setItemSubtitle("你劝我灭了心中的火。");
        messageBean1.setItemDate("April 7");
