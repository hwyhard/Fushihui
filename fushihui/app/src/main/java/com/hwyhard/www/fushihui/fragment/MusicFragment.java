...
//    }
    public void requestMusic(){
        BmobQuery<MusicTitleBean> query = new BmobQuery<>();
        query.setLimit(50)
                .findObjects(new FindListener<MusicTitleBean>() {
                    @Override
                    public void done(List<MusicTitleBean> list, BmobException e) {
                        if(e==null){
                            musicTitleBeanList = list;
    ...
    public void onMusicClick(){
        musicTitleAdapter.setOnItemClickListener(new MusicTitleAdapter.OnItemClickListener() {
            ...
            public void OnItemClick(View view, int position) {
                ...
                String musicId = musicTitleBean.getMusicItemId();
                String musicSong = musicTitleBean.getMusicTitleName();
                String musicSinger = musicTitleBean.getMusicTitleSinger();
                Bundle bundle = new Bundle();
                bundle.putString("musicId",musicId);
                bundle.putString("musicSong",musicSong);
